...
const BagItem = ({item}) =>{
  ...
  const handleBagDelete = () =>{
      dispatch(bagAction.removeFromBag(item.id)) //when action triggered dispaching a func with id
  }
    ...
    <div className="remove-from-cart" onClick={handleBagDelete}><TiDelete />
    </div>
  </div>
    )
}
